...
public class DiscordServiceImpl implements DiscordService {
	...
	public Message<String> upload(String fileName, DataUrl dataUrl) {
		try {
			...
			if (responseEntity.getStatusCode() != HttpStatus.OK) {
				log.error("Failed to upload image to discord, status: {}, msg: {}", responseEntity.getStatusCodeValue(), responseEntity.getBody());
			...
			log.error("Failed to upload image to discord", e);
	...
	public Message<String> sendImageMessage(String content, String finalFileName) {
		...
		if (responseEntity.getStatusCode() != HttpStatus.OK) {
			log.error("Failed to send image message to discord, status: {}, msg: {}", responseEntity.getStatusCodeValue(), responseEntity.getBody());
